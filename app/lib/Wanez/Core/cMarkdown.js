    ...
    iniMarkdown(){
        ...
        for(let $_Index in aData){
            ...
            if(out.startsWith(`# `)){
                ...
                tempBBCode += `[SIZE="7"]${(this.iSettings.h1.color) ? `[COLOR="${this.iSettings.h1.color}"]` : ``}${(this.iSettings.h1.underline) ? `[U]` : ``}${(this.iSettings.h1.bold) ? `[B]` : ``}${(this.iSettings.h1.italic) ? `[I]` : ``}${out}${(this.iSettings.h1.italic) ? `[/I]` : ``}${(this.iSettings.h1.bold) ? `[/B]` : ``}${(this.iSettings.h1.underline) ? `[/U]` : ``}${(this.iSettings.h1.color) ? `[/COLOR]` : ``}[/SIZE]`;
                ...
                tempBBCode += `[SIZE="6"]${(this.iSettings.h2.color) ? `[COLOR="${this.iSettings.h2.color}"]` : ``}${(this.iSettings.h2.underline) ? `[U]` : ``}${(this.iSettings.h2.bold) ? `[B]` : ``}${(this.iSettings.h2.italic) ? `[I]` : ``}${out}${(this.iSettings.h2.italic) ? `[/I]` : ``}${(this.iSettings.h2.bold) ? `[/B]` : ``}${(this.iSettings.h2.underline) ? `[/U]` : ``}${(this.iSettings.h2.color) ? `[/COLOR]` : ``}[/SIZE]`;
            }else if(out.startsWith(`### `)){
                out = out.replace(/^### /g,``).replace(/ ###$/g,``);
                ...
                tempBBCode += `[SIZE="5"]${(this.iSettings.h3.color) ? `[COLOR="${this.iSettings.h3.color}"]` : ``}${(this.iSettings.h3.underline) ? `[U]` : ``}${(this.iSettings.h3.bold) ? `[B]` : ``}${(this.iSettings.h3.italic) ? `[I]` : ``}${out}${(this.iSettings.h3.italic) ? `[/I]` : ``}${(this.iSettings.h3.bold) ? `[/B]` : ``}${(this.iSettings.h3.underline) ? `[/U]` : ``}${(this.iSettings.h3.color) ? `[/COLOR]` : ``}[/SIZE]`;
            }else if(out.startsWith(`#### `)){
                out = out.replace(/^#### /g,``).replace(/ ####$/g,``);
